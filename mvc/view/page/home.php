    ...
    <div class="layout-row home-margin">
      <div class="home-about__item">
        <p class="home-about__text">
          Xin chào, tôi là <span class="home-about__text--blue">Mai Long</span>
        </p>
        <p class="home-about__text">Chào mừng đến với blog của tôi</p>
      </div>
      <div class="home-about__item">
        <img src="<?= ROOT_URL ?>/public/image/banner/featured.png" alt="Banner-image" class="home-about__img" />
      </div>
    </div>
  </section>
      ...
      <div class="home-fearured__item post--shadow">
        <div class="home-fearured__post">
          <div class="home-fearured__post-img">
            <img src="<?= ROOT_URL ?>/<?= $item['anh_bia'] ?>" alt="Post-image" width="100%" height="100%" />
            <div></div>
          </div>
